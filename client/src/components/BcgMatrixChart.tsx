...
import { Star, DollarSign, HelpCircle, XCircle, TrendingUp } from "lucide-react";
        ...
        <div className="bg-muted/50 p-4 rounded-lg space-y-2" data-testid="bcg-interpretation">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li className="flex items-start gap-2" data-testid="interpretation-estrela">
              <Star className="h-4 w-4 text-[#1aa15c] mt-0.5 flex-shrink-0" />
              <span><span className="font-medium text-[#1aa15c]">Estrela:</span> Alto crescimento + Alta participação → Investir para manter liderança</span>
            </li>
            <li className="flex items-start gap-2" data-testid="interpretation-vaca-leiteira">
              <DollarSign className="h-4 w-4 text-[#1447e6] mt-0.5 flex-shrink-0" />
              <span><span className="font-medium text-[#1447e6]">Vaca Leiteira:</span> Baixo crescimento + Alta participação → Gerar caixa</span>
            </li>
            <li className="flex items-start gap-2" data-testid="interpretation-ponto-de-interrogação">
              <HelpCircle className="h-4 w-4 text-[#ff8c1a] mt-0.5 flex-shrink-0" />
              <span><span className="font-medium text-[#ff8c1a]">Ponto de Interrogação:</span> Alto crescimento + Baixa participação → Decisão estratégica</span>
            </li>
            <li className="flex items-start gap-2" data-testid="interpretation-abacaxi">
              <XCircle className="h-4 w-4 text-[#e5352b] mt-0.5 flex-shrink-0" />
              <span><span className="font-medium text-[#e5352b]">Abacaxi:</span> Baixo crescimento + Baixa participação → Considerar descontinuar</span>
            </li>
          </ul>
        </div>
      </CardContent>
